...
```
2. Assembling (On Windows)
```shell
    as --64 -o <obj_file> <asm_file> 
```
3. Linking and Loading (On Windows)
   **NOTE**: Linking to lmsvcrt is necessary 
```shell
...
- [x] Get Started
- [x] Variable definition and assignments
  - [x] Parsing
  - [x] Codegen
...
* [LensPlaysGames/LensorCompilerCollection](https://github.com/LensPlaysGames/LensorCompilerCollection)
* [Compiler Explorer](https://godbolt.org/)
* [Code Generation by Douglas Thain](https://www.youtube.com/watch?v=-ti07Z0xKKg)
